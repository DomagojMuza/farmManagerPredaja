<template>
    <div class="signup">
        <form @submit.prevent="signUp" method="post">
            <p class="signUpHeader">Sign up to <strong class="farmManager">farmManager</strong></p>
            ...
            <div class="inputUsername">                
                <input v-model="body.username" type="text" name="" id="username" placeholder="Enter desired username" autocomplete="off">
            </div>
...
export default {
    ...
    methods: {
        async signUp(){
            ...
            try {
                this.error = ''
                let res = await User.signUp(this.body)
                console.log(res);
